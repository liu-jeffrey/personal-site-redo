...
class Navbar extends React.Component {
    ...
    handleResize() {
        ...
        this.experienceViewOffset = this.homeViewOffset + document.querySelector("#home-view").offsetHeight;

        console.log(this.homeViewOffset);
    ...
    addButtonListeners() {
        ...
        //     document.querySelector("ExperiencePage").scrollIntoView({ behavior: "smooth" });
        // });
